...
namespace AdultType {
  ...
  //   /**
  //    * 视频文件基础名称（去除扩展名，保留标签）
  //    * @description 去除文件扩展名后的名称，保留所有标签信息
  ...
  //   /**
  //    * 视频文件是否包含中文字幕
  //    * @description 根据文件名中的标签判断是否包含中文字幕
  //    * @example true（当文件名包含 -c, -C, _ch, 中文 等标签时）
  //    */
  //   hasChineseSubtitle: boolean

  //   /**
  //    * 视频文件大小（格式化后的字符串）
  //    * @description 以 GB 为单位，保留两位小数的格式化字符串
  //    * @example "2.45 GB"
  //    */
  //   size: string
  ...
  //   /**
  //    * 视频文件分辨率信息
  //    * @description 从 NFO 文件或文件名中提取的分辨率数据
  ...
  //   /**
  //    * 视频时长 HH:MM:SS 格式
  //    * @description 从 NFO 文件或文件名中提取的时长数据
  //    */
  //   duration: string
